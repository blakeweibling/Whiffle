...
class GameConstants:
    ...
    # Aligned with README v15.8 (win score 5000) so leaderboard, Victory Lap and
    # Legend achievements trigger at the documented thresholds.
    FIVESTAR_TIMED_MODE_WIN_SCORE = 5000  # Score to win in timed mode (Five Star)
    FIVESTAR_SURVIVAL_MODE_WIN_SCORE = 5000  # Score to win in survival mode (Five Star)
    FIVESTAR_CLASSIC_MODE_WIN_SCORE = 5000  # For achievements/display only; classic has no score cap (Five Star)
