...
class GameState:
    ...
    def __init__(self, supabase_url: str, supabase_key: str) -> None:
        ...
        try:
            ...
            logger.debug("Loaded player XP data at application startup.")
        except Exception as e:
            logger.error(f"Error loading XP data at startup: {e}")
    ...
    def reset_game(self, player_name: str = "Player", game_mode: str = "classic"):
        ...
        Note: XP is persistent across sessions and must NOT be cleared here.
        Callers that want to fully reset ball/zone tracking should use the
        module-level ``reset_game`` in ``game_state_utils`` instead.
        """
