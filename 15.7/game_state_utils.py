...
from anchor_alignment import ensure_zone_alignment_state, update_effective_scoring_zones
...
def load_settings(game_state: Any) -> None:
    ...
    default_zone_alignment_enabled = False
    default_zone_alignment_settings = {"playfields": {}}
    ...
    try:
        if os.path.exists(settings_file) and os.path.getsize(settings_file) > 0:
            ...
            loaded_zone_alignment_enabled = settings_data.get(
                "zone_alignment_enabled", default_zone_alignment_enabled
            )
            game_state.zone_alignment_enabled = bool(loaded_zone_alignment_enabled)
            loaded_zone_alignment_settings = settings_data.get(
                "zone_alignment_settings", default_zone_alignment_settings
            )
            if isinstance(loaded_zone_alignment_settings, dict):
                game_state.zone_alignment_settings = loaded_zone_alignment_settings
            else:
        ...
        game_state.operator_remote_port = default_operator_remote_port
        game_state.operator_remote_pin = default_operator_remote_pin
        game_state.zone_alignment_enabled = default_zone_alignment_enabled
        game_state.zone_alignment_settings = {"playfields": {}}
    except Exception as e:
...
def save_settings(game_state: Any) -> None:
    ...
    settings_data = {
        ...
        "zone_alignment_enabled": bool(getattr(game_state, "zone_alignment_enabled", False)),
        "zone_alignment_settings": getattr(
            game_state, "zone_alignment_settings", {"playfields": {}}
        ),
        # <<< END ADDED >>>
    }
...
def reset_game(game_state: Any) -> None:
    ...
    preserved_objects = {
        ...
        "zone_alignment_enabled": getattr(game_state, "zone_alignment_enabled", False),
        "zone_alignment_settings": getattr(game_state, "zone_alignment_settings", {"playfields": {}}),
        "zone_alignment_offset_x": getattr(game_state, "zone_alignment_offset_x", 0),
        "zone_alignment_offset_y": getattr(game_state, "zone_alignment_offset_y", 0),
        "zone_alignment_confidence": getattr(game_state, "zone_alignment_confidence", 0.0),
        "zone_alignment_detected_count": getattr(game_state, "zone_alignment_detected_count", 0),
        "zone_alignment_reference_count": getattr(game_state, "zone_alignment_reference_count", 0),
        "zone_alignment_active": getattr(game_state, "zone_alignment_active", False),
        "zone_alignment_status": getattr(game_state, "zone_alignment_status", "Not calibrated"),
        "zone_alignment_last_update_time": getattr(game_state, "zone_alignment_last_update_time", 0.0),
        "zone_alignment_last_message": getattr(game_state, "zone_alignment_last_message", ""),
        "zone_alignment_observed_points": getattr(game_state, "zone_alignment_observed_points", []),
        "zone_alignment_last_detection_frame": getattr(game_state, "zone_alignment_last_detection_frame", -1),
        "effective_scoring_zones": getattr(game_state, "effective_scoring_zones", []),
        "effective_special_hole": getattr(game_state, "effective_special_hole", None),
