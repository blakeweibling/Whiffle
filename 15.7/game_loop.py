...
from anchor_alignment import get_effective_scoring_zones, refresh_zone_alignment
...
def _process_frame(frame: np.ndarray, game_state: GameState) -> None:
    ...
    try:
        silver_balls, gold_balls = game_state.detector.detect_all_balls(
            ...
            scoring_zones=get_effective_scoring_zones(game_state),
...
def run_game_loop(game_state: GameState) -> None:
    ...
    try:
        while True:
            ...
            refresh_zone_alignment(game_state, game_state.current_frame)
