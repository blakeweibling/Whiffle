...
class WhiffleGame:
    def __init__(self, root):
        ...
        # Style for buttons
        style = ttk.Style()
        style.configure("Custom.TButton", font=("Helvetica", 10), background="#2196F3", foreground="black")  # Explicitly set to black
        style.map("Custom.TButton", background=[("active", "#1976D2")], foreground=[("active", "black")])  # Ensure active state retains black
