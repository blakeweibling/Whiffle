...
# X.com (formerly Twitter) integration constants
class XConstants:
    """Constants for X.com (formerly Twitter) API integration."""

    # API keys - update these with your own values
    API_KEY = "YOUR_API_KEY"
    API_SECRET = "YOUR_API_SECRET"
    ACCESS_TOKEN = "YOUR_ACCESS_TOKEN"
    ACCESS_TOKEN_SECRET = "YOUR_ACCESS_TOKEN_SECRET"

    # X post template for sharing replays
    REPLAY_SHARE_TEMPLATE = (
        "Just scored {score} points in {game_mode} mode on Whiffle! #WhiffleGame"
    )

    # Upload settings
    REQUEST_TIMEOUT = 60  # seconds
    MAX_VIDEO_SIZE_MB = 512  # X supports up to 512MB for API uploads

    # Additional settings
    INCLUDE_PLAYER_NAME = True  # Whether to include player name in posts
