...
def _draw_volume_slider(
    ...
    cv2.putText(
        menu_frame, label_text, (label_x, label_y), cv2.FONT_HERSHEY_SIMPLEX,
        UIConstants.FONT_SCALE_MEDIUM, UIConstants.WHITE, 1, cv2.LINE_AA
    )
    ...
    text_width = cv2.getTextSize(percent_text, cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_SMALL, 1)[0][0]
    text_x = current_x
    ...
    _draw_button(
        menu_frame, mute_button_x, mute_button_y, button_width, slider_height, mute_text, mute_color,
        # <<< ADDED game_state >>>
...
def _draw_settings_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    _draw_button(
        menu_frame, track_button_x, y_offset, button_width, item_height, track_display_text, UIConstants.CV2_BLUE,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_SMALL
    )
    if total_tracks > 0:
        game_state.submenu_items.append(((track_button_x, y_offset, button_width, item_height), "cycle_music_track", "Cycle Music Track"))
    y_offset += item_height + 5

    debug_toggles = [
        ("Visual Debug Overlay", lambda: game_state.show_debug_overlay, "toggle_debug_overlay"),
    ...
    for label, get_state, action in debug_toggles:
        ...
        _draw_button(
            menu_frame, button_x, y_offset, toggle_button_width, item_height, state_text, state_color,
            # <<< ADDED game_state >>>
            game_state=game_state,
    ...
    _draw_button(
        menu_frame, 20, back_y, menu_frame.shape[1] - 40, back_button_height, "Back", UIConstants.CV2_BLUE,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_MEDIUM
    )
...
def _draw_leaderboard_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    if not scores:
        cv2.putText(menu_frame, "No scores available.", (20, y_offset + 20), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_MEDIUM, UIConstants.WHITE, 1)
        y_offset += item_height + 5
    else:
        ...
        for i, score_entry in enumerate(scores):
            ...
            cv2.putText(menu_frame, entry_text, (20, y_offset + item_height), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_SMALL, UIConstants.WHITE, 1)
    ...
    _draw_button(
        menu_frame, classic_x, mode_button_y, mode_button_width, mode_button_height, "Classic", classic_color,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_SMALL
    )
    ...
    _draw_button(
        menu_frame, timed_x, mode_button_y, mode_button_width, mode_button_height, "Timed", timed_color,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_SMALL
    )
    ...
    _draw_button(
        menu_frame, survival_x, mode_button_y, mode_button_width, mode_button_height, "Survival", survival_color,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_SMALL
    )
...
def _draw_players_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    if (game_state.editing_player_mode == "edit_name" and game_state.editing_player_index is not None):
        cv2.putText(menu_frame, "Enter Name (A-Z, 0-9), Bksp, Enter=Save, ESC=Cancel", (20, y_offset - 5), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_SMALL, UIConstants.YELLOW, 1)
        y_offset += 15
    ...
    for i, player in enumerate(game_state.players):
        ...
        cv2.putText(menu_frame, display_name[:max_name_len], (20, y_offset + 25), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_MEDIUM, name_color, 1)
        ...
        _draw_button(
            menu_frame, edit_x, y_offset, button_width, item_height, "Edit", edit_color,
            # <<< ADDED game_state >>>
            game_state=game_state,
            font_scale=UIConstants.FONT_SCALE_SMALL
        )
        ...
        if (game_state.editing_player_index == i and game_state.editing_player_mode == "edit_name"):
            _draw_button(
                menu_frame, select_x, y_offset, button_width, item_height, "-", UIConstants.GREY_BG,
                # <<< ADDED game_state >>>
                game_state=game_state,
                font_scale=UIConstants.FONT_SCALE_SMALL
            )
            ...
            _draw_button(
                menu_frame, select_x, y_offset, button_width, item_height, select_text, select_color,
                # <<< ADDED game_state >>>
                game_state=game_state,
                font_scale=UIConstants.FONT_SCALE_SMALL
            )
    ...
    _draw_button(
        menu_frame, 20, add_y, menu_frame.shape[1] - 40, item_height, "Add Player", add_color,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_MEDIUM
    )
    ...
    back_y = y_offset + 10
    _draw_button(
        menu_frame, 20, back_y, menu_frame.shape[1] - 40, item_height, "Back", UIConstants.CV2_BLUE,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_MEDIUM
    )
...
def _draw_achievements_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    cv2.putText(menu_frame, status_text, (20, y_offset - 20), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_MEDIUM, UIConstants.YELLOW, 1)

    if not game_state.achievements:
        cv2.putText(menu_frame, "No achievements defined.", (20, y_offset + 20), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_MEDIUM, UIConstants.WHITE, 1)
        y_offset += item_height + 5
    else:
...
def _draw_help_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    game_state.submenu_items.clear()
    help_text = [
        "Controls:", "  'm' / Click Menu Btn : Toggle Menu", "  's' : Start/Stop drawing zone",
        "  'd' : Toggle Debug Logs", "  'b' : Toggle Debug Overlay", "  'p' : Pause/Resume Game",
        "  'q' / ESC: Quit Game", "  BACKSPACE: Go back in menu", "", "Gameplay:",
        "  - Define/Edit zones via Menu > Manage Zones.", "  - Score points by getting balls into zones.",
        "  - Leftmost zone is 'Special Hole'.", "  - Change modes in Menu > Game Mode.",
        "  - Edit names in Menu > Players.",
    ]
    for line in help_text:
        cv2.putText(menu_frame, line, (20, y_offset + item_height), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_SMALL, UIConstants.WHITE, 1)
        y_offset += item_height
...
def _draw_faq_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    game_state.submenu_items.clear()
    faq_text = [
        "Q: Why aren't balls detected?", "A: Check lighting. Use Debug Overlay ('b').", "",
        "Q: How do I define zones accurately?", "A: Use 's' key, drag. Edit in Menu > Manage Zones.", "",
        "Q: What's the 'Special Hole'?", "A: Leftmost zone, may give bonus points.", "",
        "Q: Why is Edit Zones list cut off?", "A: Use Prev/Next buttons for pagination.",
    ]
...
def _draw_about_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    item_height = 35
    game_state.submenu_items.clear()
    cv2.putText(menu_frame, "Whiffle Tracker v12.X", (20, y_offset), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_MEDIUM, UIConstants.WHITE, 1)
    y_offset += item_height
    ...
    splash_y = y_offset
    _draw_button(
        menu_frame, 20, splash_y, menu_frame.shape[1] - 40, item_height, "Show Splash", UIConstants.CV2_BLUE,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_MEDIUM
    )
...
def _draw_edit_zones_submenu(menu_frame: np.ndarray, game_state: "GameState") -> None:
    ...
    if (game_state.editing_zone_mode == "confirm_delete" and game_state.editing_zone_index is not None and start_index <= game_state.editing_zone_index < end_index):
    ...
    if (game_state.editing_zone_mode == "edit_points" and game_state.editing_zone_index is not None and start_index <= game_state.editing_zone_index < end_index):
    ...
    if top_message:
        cv2.putText(menu_frame, top_message, (20, y_offset - 5), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_SMALL, UIConstants.YELLOW, 1)
        y_offset += 15

    if not game_state.scoring_zones:
        cv2.putText(menu_frame, "No zones defined.", (20, y_offset + 20), cv2.FONT_HERSHEY_SIMPLEX, UIConstants.FONT_SCALE_MEDIUM, UIConstants.WHITE, 1)
        y_offset += item_height + 5
    else:
        ...
        for i_display, zone_data in enumerate(zones_to_display):
            ...
            _draw_button(
                menu_frame, button_x, y_offset, button_width, item_height, "Pts", edit_color,
                # <<< ADDED game_state >>>
                game_state=game_state,
                font_scale=UIConstants.FONT_SCALE_SMALL
            )
            ...
            _draw_button(
                menu_frame, button_x, y_offset, button_width, item_height, "Move", move_color,
                # <<< ADDED game_state >>>
                game_state=game_state,
                font_scale=UIConstants.FONT_SCALE_SMALL
            )
            ...
            _draw_button(
                menu_frame, button_x, y_offset, button_width, item_height, "Resize", resize_color,
                # <<< ADDED game_state >>>
                game_state=game_state,
                font_scale=UIConstants.FONT_SCALE_SMALL
            )
            ...
            _draw_button(
                menu_frame, button_x, y_offset, button_width, item_height, "Del", delete_color,
                # <<< ADDED game_state >>>
                game_state=game_state,
                font_scale=UIConstants.FONT_SCALE_SMALL
            )
    ...
    _draw_button(
        menu_frame, prev_button_x, page_y_start, page_button_width, page_item_height, "Previous", prev_color,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_SMALL
    )
    ...
    _draw_button(
        menu_frame, next_button_x, page_y_start, page_button_width, page_item_height, "Next", next_color,
        # <<< ADDED game_state >>>
        game_state=game_state,
        font_scale=UIConstants.FONT_SCALE_SMALL
    )
