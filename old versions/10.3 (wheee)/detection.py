...
class BallDetector:
    def __init__(self):
        ...
        try:
            ...
            logger.warning("Could not set OpenCL backend for YOLOv8. Ensure the model is compatible and OpenCL is supported.")
    ...
    def detect_all_balls(
        ...
        results = self.model(inference_frame, conf=0.5, iou=0.5)  # Adjust confidence and IoU thresholds as needed
