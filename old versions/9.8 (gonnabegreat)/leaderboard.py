...
class Leaderboard:
    ...
    def submit_score(self, player_name: str, score: int, mode: str) -> bool:
        ...
        try:
            ...
            logger.info(f"Successfully submitted score to online leaderboard: {player_name} - {score} ({mode})")
            return True
        except requests.RequestException:
            logger.warning(f"Failed to submit score to online leaderboard, saved locally: {player_name} - {score} ({mode})")
            return False
