...
class UIConstants:
    ...
    # --- MODIFIED LINES ---
    WINDOW_WIDTH: int = _assert_positive(1920, "WINDOW_WIDTH")
    WINDOW_HEIGHT: int = _assert_positive(1080, "WINDOW_HEIGHT")
    # --- END MODIFIED LINES ---
    ...
    SLIDER_PADDING: int = 5  # Padding around the slider bar
    # --- END NEW ---

    # --- Click Feedback ---
    CLICK_FEEDBACK_DURATION: float = 0.2  # Duration in seconds for click highlight
...
class GameConstants:
    ...
    SETTINGS_FILE: str = "settings.json"  # <<< NEW: For saving settings like volume
    ...
    RETRO_PIXEL_FACTOR: int = _assert_positive(
        3, "RETRO_PIXEL_FACTOR")  # Lower value = more pixelated
    # --- END ADDITION ---
