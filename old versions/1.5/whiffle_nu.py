...
class WhiffleGame:
    ...
    def update_frame(self):
        ...
        if key == ord('q'):
            ...
            print(f"'s' pressed, save triggered: {self.save_triggered}")  # Debug

        # Handle save in the update loop to avoid GIL issues
        if self.save_triggered and self.calibrating:
            ...
            self.save_triggered = False
            self.update_frame()  # Force refresh to scoring mode
