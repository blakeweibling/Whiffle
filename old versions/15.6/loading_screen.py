...
class LoadingScreen:
    ...
    def __init__(
        self,
        window_name: str = "Whiffle Tracker - Loading...",
        width: int = 600,
        height: int = 400,
    ):
    ...
    def _update_loop(self):
        ...
        try:
            ...
            if sys.platform == "win32":
                ...
                logger.debug(f"Centered loading window at ({x_pos}, {y_pos})")
            else:
    ...
    def update_stage(self, stage_text: str, progress_increment: float = 0.05):
        ...
        logger.debug(f"Loading stage: {stage_text}, Progress: {self.progress:.0%}")
    ...
    def finish(self):
        ...
        logger.debug("Loading screen finished")
