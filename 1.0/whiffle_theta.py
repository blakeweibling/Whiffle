...
class WhiffleGame:
    def __init__(self, root):
        ...
        # Style for buttons
        style = ttk.Style()
        style.configure("Custom.TButton", font=("Helvetica", 10), background="#2196F3", foreground="white")
    ...
    def canvas_click(self, event):
        ...
        self.current_entry = tk.simpledialog.askstring("Points", f"Points for zone at ({x}, {y}):", parent=self.root)
