...
class OptionsWindow:
    def __init__(self, on_close_callback, game_instance):
        ...
        ttk.Label(frame, text="Red Ball Detection", font=("Helvetica", 12, "bold"), style="Custom.TLabel").pack(pady=5)
    ...
    def render_frame(self):
        ...
        if self.frame is not None:
            ...
            for x_frame, y_frame, r, points in self.point_zones:
                ...
                self.red_zone_texts.append(self.canvas.create_text(x_canvas, y_canvas, text=str(points), fill="white", font=("Helvetica", 10)))
