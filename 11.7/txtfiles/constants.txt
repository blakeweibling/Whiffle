...
class UIConstants:
    ...
    MENU_CLOSE_BUTTON_SIZE: int = _assert_positive(40, "MENU_CLOSE_BUTTON_SIZE") # Size of the square button
    MENU_CLOSE_BUTTON_PADDING: int = _assert_non_negative(10, "MENU_CLOSE_BUTTON_PADDING") # Padding from menu corner
    MENU_CLOSE_BUTTON_COLOR: Tuple[int, int, int] = RED # Color of the 'X'
    MENU_CLOSE_BUTTON_THICKNESS: int = _assert_positive(2, "MENU_CLOSE_BUTTON_THICKNESS") # Thickness of the 'X'
    # --- END NEW ---
