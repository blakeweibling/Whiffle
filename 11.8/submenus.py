...
def _draw_settings_submenu(menu_frame: np.ndarray, game_state: Any) -> None:
    ...
    settings_items = [
        ...
        ToggleItem( # <<< ADDED Ball Trails Toggle >>>
            "Ball Trails",
            lambda: game_state.ball_trails_enabled,
            lambda: setattr(game_state, "ball_trails_enabled", not game_state.ball_trails_enabled)
        ),
        ToggleItem(
