...
def _draw_game_over_screen(frame: np.ndarray, game_state: "GameState") -> None:
    ...
    _draw_button(frame, play_again_x, button_y, button_width, button_height, "Play Again (N)", UIConstants.CV2_BLUE, game_state=game_state)
    ...
    _draw_button(frame, menu_x, button_y, button_width, button_height, "Main Menu (M)", UIConstants.CV2_BLUE, game_state=game_state)
    
    # Heatmap button (new)
    heatmap_x = menu_x + button_width + button_spacing
    heatmap_rect = (heatmap_x, button_y, button_width, button_height)
    _draw_button(frame, heatmap_x, button_y, button_width, button_height, "Show Heatmap (H)", UIConstants.CV2_BLUE, game_state=game_state)
