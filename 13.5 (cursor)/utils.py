                    ...
                    if action == "quit":
                        ...
                        if (
                            ...
                            game_state.menu_cache = (
                                None  # Clear menu cache when changing modes
                            )
                            if new_mode == "retro":
                                available_tracks = getattr(
                                    GameConstants, "BACKGROUND_MUSIC_TRACKS", []
                            ...
                            reset_game(
                                game_state
                            )  # Reset game state after all mode-specific changes
                            show_notification(
                        ...
                        if getattr(game_state, "edit_zones_current_page", 1) > 1:
                        ...
                        total_pages = max(
                            ...
                            ceil(
                                ...
                                / getattr(game_state, "edit_zones_items_per_page", 8)
                            ),
                        )
                        if (
                        ...
                        try:
                            ...
                            if 0 <= index < len(
                                ...
                                getattr(game_state, "editing_zone_index", None) == index
...
def _process_game_over_click(
    x: int, y: int, game_state: "GameState", mouse_callback: Callable
) -> bool:
    """
