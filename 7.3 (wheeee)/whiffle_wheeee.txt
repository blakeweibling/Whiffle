...
# Display splash screen while reinitializing camera
    ...
    try:
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT:
                ...
                if DEBUG and event.type == pygame.MOUSEBUTTONDOWN:
                    print(f"Menu handled click: {handled}")
                if not handled:
                    if about_window.active:
                        about_window.handle_input(event)
                    elif settings_window.active:
