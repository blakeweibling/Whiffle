    ...
    if hasattr(game_state, "tracked_balls"):
        for ball in game_state.tracked_balls:
            try:
                ...
                if len(ball) >= 6:
                    x, y, radius, ball_id, age, ball_type = ball[:6] # Unpack only the first 6
            ...
            except (IndexError, ValueError, TypeError) as e: # Catch potential unpacking/conversion errors
                logger.warning(
