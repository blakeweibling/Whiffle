...
class WhiffleGame:
    def __init__(self, root):
        ...
        self.input_text = ""
        self.paused = False  # Flag to pause video updates during dialog
    ...
    def options_menu(self):
        self.paused = True  # Pause video updates
        OptionsWindow()
        self.paused = False  # Resume video updates
    ...
    def update_frame(self):
        if self.paused:
            # Skip frame updates while paused (e.g., during dialog)
