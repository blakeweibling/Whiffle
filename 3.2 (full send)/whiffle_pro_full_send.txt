...
class HelpWindow:
    def __init__(self, on_close_callback):
        ...
        tk.Label(self.frame, text="Help", font=("Helvetica", 14, "bold"), bg="#2E2E2E", fg="white").pack(pdy=10)
        ...
        for line in help_lines:
            tk.Label(self.frame, text=line, font=("Helvetica", 10), bg="#2E2E2E", fg="white").pack(pdy=5)

        ttk.Button(self.frame, text="Close", style="Custom.TButton", command=self.close).pack(pdy=10)
...
class WhiffleGame:
    ...
    def file_menu(self):
        ...
        tk.Label(frame, text="File Options", font=("Helvetica", 14, "bold"), bg="#2E2E2E", fg="white").pack(pdy=10)
        tk.Button(frame, text="Save", font=("Helvetica", 10), bg="#4CAF50", fg="white", 
                  command=lambda: self.save_file(file_window)).pack(pdy=5)
        tk.Button(frame, text="Load", font=("Helvetica", 10), bg="#2196F3", fg="white", 
                  command=lambda: self.load_file(file_window)).pack(pdy=5)
    ...
    def high_score(self):
        ...
        tk.Label(frame, text=f"High Score: {high_score} by {high_score_initials}", font=("Helvetica", 14), bg="#2E2E2E", fg="white").pack(pdy=10)
        tk.Button(frame, text="Close", font=("Helvetica", 10), bg="#F44336", fg="white", 
                  command=lambda: self.close_high_score(high_score_window)).pack(pdy=5)
