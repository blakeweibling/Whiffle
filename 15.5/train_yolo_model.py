...
def train_model(
    ...
    print(f"\nTo use this model, copy it to the data directory:")
    print(f"  cp {results.save_dir}/weights/best.pt data/whiffle_new_best_fivestar.pt")
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["silver", "gold"],
        help="List of class names (default: silver gold)"
    )
    parser.add_argument(
        "--model",
        type=str,
        default=None,
        help="Path to pretrained model (e.g., 'yolov8n.pt' or 'data/whiffle_new_best_fivestar.pt' for fine-tuning)"
    )
    parser.add_argument(
        "--epochs",
        type=int,
    ...
    parser.add_argument(
        "--name",
        type=str,
        default="fivestar_detection",
        help="Experiment name (default: fivestar_detection)"
    )
    parser.add_argument(
        "--validate",
        action="store_true",
