...
def _match_balls(
    ...
    try:
        # Optimized KD-tree approach (requires scipy)
        ...
        for i, (dist, idx) in enumerate(zip(distances, indices)):
            if dist != float('inf') and idx < len(tracked_balls):  # Valid match
        ...
        for i, (new_x, new_y, radius, ball_type) in enumerate(new_balls):
            ...
            if closest_ball_idx is not None:
                _, _, _, ball_id, age, _ = tracked_balls[closest_ball_idx]
                matched_balls.append((new_x, new_y, radius, ball_id, ball_type))
                matched_new_indices.append(i)
...
def _add_new_balls(
    ...
    Returns:
        List of (x, y, radius, ball_id, ball_type) tuples for all tracked balls in the current frame.
    """
...
def track_balls(
    ...
    tracked_detected_balls = _add_new_balls(new_balls, tracked_balls, matched_new_indices, next_ball_id, 
                                           scored_positions, frame_count, debug_mode)
