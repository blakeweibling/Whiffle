...
class AboutWindow:
    ...
    def draw(self, screen):
        ...
        screen.blit(self.window_surface, ((WIDTH - self.window_width) // 2, (HEIGHT - self.window_height) // 2))
    ...
    def handle_input(self, event):
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
            mouse_pos = event.pos
            window_x = (WIDTH - self.window_width) // 2
            window_y = (HEIGHT - self.window_height) // 2
