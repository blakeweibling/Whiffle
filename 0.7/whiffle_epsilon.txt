        ...
        for item, (x_start, x_end) in menu_positions.items():
            if x_start <= x <= x_end:
                ...
                if item == "File":
                    ...
                    cv2.putText(help_frame, "Menu: File (save/load)", (10, 80), 
                                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
                    cv2.putText(help_frame, "New Game (reset), High Score (view)", (10, 110), 
                                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
                    cv2.putText(help_frame, "Options (settings), Press any key", (10, 140), 
                                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
                    cv2.putText(help_frame, "to continue", (10, 170), 
                                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
