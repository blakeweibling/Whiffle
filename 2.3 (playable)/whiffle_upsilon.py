...
BALL_COLOR_RANGE = {"lower_white": [0, 0, 220], "upper_white": [180, 30, 255]}  # Narrowed range to reduce wall detection
MIN_CONTOUR_AREA = 50  # Minimum area to filter out small noise or large background
