...
class GameState:
    ...
    def __init__(self, supabase_url: str, supabase_key: str) -> None:
        ...
        # <<< MODIFIED TYPE HINT >>> Optional list stored here by menu/ui drawing functions
        ...
        # <<< ADDED FOR CLICK FEEDBACK >>>
        # Stores the rectangle (x,y,w,h) of the last clicked button for 1 frame
        self.clicked_button_rect: Optional[Tuple[int, int, int, int]] = None
        # <<< END ADDED >>>
        ...
        logger.info("Initializing achievements via utils...")
    ...
    def get_current_player(self) -> Player:
        ...
        logger.warning(
            f"Player index {self.current_player_index} invalid. Returning fallback."
        )
        if not self.players:
