...
def _draw_existing_zones(overlay: np.ndarray, scoring_zones: List[Tuple[int, int, int, int, int]], special_hole: Optional[Tuple[int, int, int, int, int]] = None) -> None:
    ...
    for zone in scoring_zones:
        ...
        label = f"{points} pts (Special Hole)" if zone == special_hole else f"{points} pts"
...
def draw_scoring_zones(frame: np.ndarray, scoring_zones: List[Tuple[int, int, int, int, int]], special_hole: Optional[Tuple[int, int, int, int, int]] = None) -> None:
    """
