...
EXCLUDED_POSITIONS: List[Tuple[int, int]
                         ] = GameSpecificConstants.EXCLUDED_POSITIONS
    ...
    def detect_all_balls(
        ...
        for result in results:
            ...
            for box, score, cls in zip(boxes, scores, classes):
                ...
                # Scale coordinates back to original resolution
                x_min, x_max = int(
                    x_min * scale_factor), int(x_max * scale_factor)
                y_min, y_max = int(
                    y_min * scale_factor), int(y_max * scale_factor)
        ...
        if debug_mode:
            ...
            for x, y, radius in white_balls:
                cv2.circle(debug_frame, (x, y), int(
