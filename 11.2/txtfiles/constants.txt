...
class GameConstants:
    ...
    # Scoring Logic
    POSITION_HISTORY_LENGTH: int = _assert_positive(
        5, "POSITION_HISTORY_LENGTH")
    ...
    # Audio
    DEFAULT_SOUND_VOLUME: float = _assert_fractional(
        0.7, "DEFAULT_SOUND_VOLUME")
    DEFAULT_MUSIC_VOLUME: float = _assert_fractional(
        0.5, "DEFAULT_MUSIC_VOLUME")
...
class PlayerConstants:
    ...
    ALLOWED_PLAYER_NAME_CHARS: str = string.ascii_letters + string.digits + " _-" # Allow letters, digits, space, underscore, hyphen
