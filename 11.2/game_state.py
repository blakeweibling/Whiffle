...
class GameState:
    def __init__(self, supabase_url: str, supabase_key: str) -> None:
        ...
        self.player_name_input_active: bool = True # Flag to indicate if initial input is needed
        ...
        try:
            ...
            if isinstance(sound_results, tuple) and len(sound_results) == 3:
                ...
                self.score_sound, self.background_music, self.low_time_sound, self.achievement_sound = (
                    None, None, None, None,
                )
        except Exception as e:
            logger.exception(
